...
while True:
    ...
    for row in all_news:
                ...
                if get_check_status_new == '0' :
                    ...
                    if all_infor and all_infor.get('title')!='':
                        result_insert = query_insert('infor_news', 
                            ...
                            price = 'Thỏa thuận' if not all_infor.get('price') else all_infor.get('price').replace(',','.'),
                                ...
                                categoty = '' if not all_infor.get('title_add') else all_infor.get('title_add'),
                                provines = '' if not all_infor.get('title_provines') else all_infor.get('title_provines'))
                    else:
                        continue
                    #UPDATE STATUS NEWS
